...
using Task = TodolistBackend.Models.Task; 
...
namespace TodolistBackend.Controllers
{
    ...
    public class TasksController : ControllerBase
    {
        ...
        // POST: api/Tasks
        [HttpPost]
        public async System.Threading.Tasks.Task<ActionResult<Task>> CreateTask(Task task)
        {
        ...
        // PUT: api/Tasks/5
        [HttpPut("{id}")]
        public async System.Threading.Tasks.Task<IActionResult> UpdateTask(int id, Task task)
        {
            if (id != task.Id)
            {
                return BadRequest();
